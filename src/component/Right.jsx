...
export const Right = () => {
  ...
  const saveSegment = () => {
    ...
    //make a api call to post the apiparams as post request at an end point using axios
  ...
  return (
    <div className="container rightwrapper">
      ...
      <div className="two">
        ...
        {/* TO DO: Never use br always use margin bottom ot margin top */}
        <br />
        ...
        {/* <Dropdown options={options} selectedObj={selectedObj}/> */}
